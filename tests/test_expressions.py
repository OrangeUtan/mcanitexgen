...
def assert_animation(
    json: Dict,
    expected: AnimatedGroup,
    texture_animations: Dict[str, TextureAnimation] = dict(),
):
...
class TestMarks:
    def test_marks_in_state_and_sequence(self):
        assert_marks(
            {
                "states": ["a", "b", "c"],
                "sequences": {"seq_a": [{"state": "c", "duration": 10, "mark": "in seq_a"}]},
                "animation": [
    ...
    def test_marks_in_repeated_entries(self):
        assert_marks(
            {
                "states": ["a", "b", "c"],
                "sequences": {"seq_a": [{"state": "a", "duration": 5, "mark": "in seq_a"}]},
                "animation": [
            ...
            },
            {
                ...
                "seq_a": [AnimationMark(30, 35), AnimationMark(35, 40), AnimationMark(40, 45)],
                "in seq_a": [
                    AnimationMark(30, 35),
                    AnimationMark(35, 40),
                    AnimationMark(40, 45),
        ...
        assert_marks(
            {
                "states": ["a", "b", "c"],
                "sequences": {"seq_a": [{"state": "a", "duration": 5, "mark": "in seq_a"}]},
                "animation": [{"sequence": "seq_a"}, {"sequence": "seq_a"}],
            },
            {
                "in seq_a": [
                    AnimationMark(0, 5),
...
class TestVariables:
    def test_basic(self):
        assert_constants(
            {
                "constants": {"x": "(4+5)-(1+2+3)", "y": "pow(3,3)"},
                "states": ["a", "b", "c"],
                "animation": [{"state": "a", "duration": 10}],
            },
            {"x": 3, "y": 27},
        )
    ...
    def test_reference_const_in_sequence(self):
        assert_animation(
            {
                "constants": {"seq_a_duration": 20, "state_a": 42},
                "states": ["a", "b", "c"],
                "sequences": {
                    "seq_a": [
                        {"state": "b", "weight": 1},
            ...
            AnimatedGroup(
                ...
                [
                    ...
                    AnimatedGroup(42, 62, "seq_a", [AnimatedState(42, 62, 1)]),
                ],
            ),
        )
...
class TestEndExpr:
    texture_animations = {
        "ta1": TextureAnimation.from_json(
            "ta1",
            {
                "states": ["a", "b", "c"],
                "sequences": {
                    "seq_a": [{"state": "a", "duration": 5, "mark": "in seq_a"}],
                    "seq_b": [{"state": "b", "duration": 5, "mark": "in seq_b"}],
                },
                "animation": [
                    {"sequence": "seq_a", "mark": "seq_a"},
    ...
    def test_basic_nested(self):
        assert_animation(
            {
                "states": ["a", "b", "c"],
                "sequences": {"seq_a": [{"state": "b", "end": 95}]},
                "animation": [
                    {"state": "a", "duration": 5},
                    {"sequence": "seq_a"},
                    {"state": "a", "duration": 5},
            ...
            AnimatedGroup(
                ...
                [
                    AnimatedState(0, 5, 0),
                    AnimatedGroup(5, 95, "seq_a", [AnimatedState(5, 95, 1)]),
    ...
    def test_already_reached(self):
        ...
        assert_exception(
            ...
            "Sequence '': 2. entry can't end at '95'",
        )
    ...
    def test_already_reached_nested(self):
        assert_exception(
            ...
            MCAnitexgenException,
            "Sequence 'seq_a': 1. entry can't end at '95'",
        )
    ...
    def test_with_mark_reference(self):
        assert_animation(
            {
                "states": ["a", "b", "c"],
                "animation": [{"state": "a", "end": "ta1.mark('seq_b').end"}],
            },
            AnimatedGroup(0, 10, "", [AnimatedState(0, 10, 0)]),
...
class TestStartExpr:
    def test_basic(self):
        assert_animation(
            ...
            AnimatedGroup(
                ...
                100,
                "",
                [AnimatedState(0, 85, 0), AnimatedState(85, 95, 1), AnimatedState(95, 100, 0)],
            ),
        )
    ...
    def test_basic_nested(self):
        assert_animation(
            {
                "states": ["a", "b", "c"],
                "sequences": {"seq_a": [{"state": "b", "start": 85, "duration": 10}]},  # <--
                "animation": [
                    {"state": "a", "duration": 5},
                    {"sequence": "seq_a"},
                    {"state": "a", "duration": 5},
            ...
            AnimatedGroup(
                ...
                [
                    ...
                    AnimatedGroup(85, 95, "seq_a", [AnimatedState(85, 95, 1)]),
                    AnimatedState(95, 100, 0),
                ],
            ),
        )
        ...
        assert_animation(
            {
                "states": ["a", "b", "c"],
                "sequences": {
                    "seq_a": [{"state": "a", "duration": 5}, {"state": "b", "duration": 5}]
                },
                "animation": [
                    {"sequence": "seq_a"},
            ...
            AnimatedGroup(
                ...
                [
                    AnimatedGroup(
                        0, 20, "seq_a", [AnimatedState(0, 5, 0), AnimatedState(5, 20, 1)]
                    ),
